...
namespace Hillrange\CKEditor\DependencyInjection;

use Hillrange\CKEditor\Form\CKEditorType;
use Hillrange\CKEditor\Exception\DependencyInjectionException;
use Hillrange\CKEditor\Util\ConfigManager;
use Hillrange\CKEditor\Util\ToolbarManager;
 ...
 */
class HillrangeCKEditorExtension extends ConfigurableExtension
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $formType = $container->getDefinition(CKEditorType::class);
    ...
    {
        $definition = $container->getDefinition(ToolbarManager::class);
    ...
    private function registerFilebrowsers(array $config, ContainerBuilder $container)
    {
        if (!empty($config['filebrowsers'])) {
            $container
                ->getDefinition(CKEditorType::class)
